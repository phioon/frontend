            ...
            <Row className="justify-content-center">
              <Col xs="7" md="7">
                <FormGroup className={`has-label ${position.states.startedOn}`}>
                  ...
                  <UncontrolledTooltip placement="top-start" target={"input_date_hint"}>
            ...
            <Row className="justify-content-center">
              <Col xs="7" md="7">
                <FormGroup className={`has-label ${position.states.s_price}`}>
                  ...
                  <UncontrolledTooltip placement="top-start" target={"input_price_hint"}>
            ...
            <Row className="justify-content-center">
              <Col xs="7" md="7">
                <FormGroup>
                  ...
                  <UncontrolledTooltip placement="top-start" target={"input_cost_hint"}>
            ...
            <Row className="justify-content-center">
              ...
              <Col xs="7" md="7">
                <FormGroup>
                  ...
                  <UncontrolledTooltip placement="top-start" target={"input_opCost_hint"}>
            ...
            <Row className="justify-content-center">
              ...
              <Col xs="7" md="7">
                <FormGroup>
                  ...
                  <UncontrolledTooltip placement="top-start" target={"input_totalCost_hint"}>
