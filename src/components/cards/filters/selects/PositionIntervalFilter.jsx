...
class PositionIntervalFilter extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getSelectedPositions(dateFrom, dateTo) {
    ...
    for (var obj of dimension.data) {
      let startedOn = new Date(obj.value)
  ...
  render() {
    ...
    return (
      <CardBody>
        ...
        { this.props.allowIntervalExchange &&
          <Row className="justify-content-end">
            <Button
              ...
              size="sm"
              outline>
              <small>{getString(langId, compId, "btn_useCloseInterval")}</small>
            </Button>
          </Row>
        }
...
export default PositionIntervalFilter;

PositionIntervalFilter.propTypes = {
