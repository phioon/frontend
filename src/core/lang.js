...
const strings = {
  enUS: {
    ...
    modalstrategy: {
      ...
      input_description: "Description",
      label_description_placeholder: "A well written explanation may help other people understand how your Strategy works...",
      input_public: "Public",
  ...
  ptBR: {
    ...
    modalstrategy: {
      ...
      input_description: "Descrição",
      label_description_placeholder: "Uma explicação bem escrita pode ajudar outros a entender melhor como sua Estratégia funciona...",
