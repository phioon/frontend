const locale = {
  phioon: {
    email_support: "meajuda@phioon.com"
  },
  generic: {
  ...
  indicators: {
    ...
    sma_close_50: "MMA 50",
    sma_close_55: "MMA 55",
    sma_close_100: "MMA 100",
    sma_close_200: "MMA 200",
    ...
    ema_close_50: "MME 50",
    ema_close_72: "MME 72",
    ema_close_144: "MME 144",
    ema_close_200: "MME 200",
    ema_close_305: "MME 305",
    ema_close_610: "MME 610",
    ema_close_1292: "MME 1292",
    ema_close_2584: "MME 2584",
    ...
    roc_ema_close_8: "ROC MME 8",
    roc_ema_close_9: "ROC MME 9",
    roc_ema_close_17: "ROC MME 17",
    roc_ema_close_34: "ROC MME 34",
    roc_ema_close_50: "ROC MME 50",
    roc_ema_close_72: "ROC MME 72",
    roc_ema_close_144: "ROC MME 144",
    roc_ema_close_200: "ROC MME 200",
    roc_ema_close_305: "ROC MME 305",
    roc_ema_close_610: "ROC MME 610",
    roc_ema_close_1292: "ROC MME 1292",
    roc_ema_close_2584: "ROC MME 2584",

    roc_sma_close_7: "ROC MMA 7",
    roc_sma_close_10: "ROC MMA 10",
    roc_sma_close_20: "ROC MMA 20",
    roc_sma_close_21: "ROC MMA 21",
    roc_sma_close_30: "ROC MMA 30",
    roc_sma_close_50: "ROC MMA 50",
    roc_sma_close_55: "ROC MMA 55",
    roc_sma_close_100: "ROC MMA 100",
    roc_sma_close_200: "ROC MMA 200",
  },
  languages: {
    enUS: "English",
    ptBR: "Português",
  ...
  measures: {
    ...
    closeVolume_title_hint: "Considerando apenas as posições fechadas, eu somo o valor de fechamento. Por exemplo: em uma posição de COMPRA, vou somar seu valor de venda.",
  ...
  modalstrategy: {
    ...
    label_basic_0: "Último Candle",
    label_basic_0_intro: "Defina como os indicadores devem estar alinhados",
    label_basic_1: "Candle Anterior",
    label_basic_1_intro: "Defina como os indicadores devem estar alinhados",
  ...
  modalusercreated: {
    ...
    stepDesc2: "Com a conta ativada, você está liberado para usar nossa plataforma.",
    stepTitle3: "3. Potencialize seus resultados",
    stepDesc3: "Se torne ainda mais eficiente no mercado financeiro.",
    footer_p1: "Se surgir alguma dúvida, mande uma mensagem pra gente no",
    footer_p2: "Estamos aqui para te ajudar ;)",
  ...
  phitrader: {
    ...
    label_noWallets_p1: "Hmm... Parece que você ainda tem Carteiras criadas por aqui... Que tal criar a primeira?",
    label_noWallets_p2: "Dessa forma, vou saber em qual Bolsa de Valores você trabalha e então compartilhar minhas operações com você! ;)",
    btn_goToWallets: "Ir para Carteiras",
  ...
  phioperationcard: {
    ...
    label_waiting: "Aguardando Preço de Entrada...",
    label_canceled: "Era cilada!",
    label_gain: "Deu Gain! \\o/",
    label_loss: "Stop Loss acionado. :/",
    label_buyingArea: "Operação ativa e oferecendo relação Risco/Retorno ainda melhor.",
    label_sellingArea: "Operação ativa e oferecendo relação Risco/Retorno ainda melhor.",
    ...
    entryPrice_hint: "Preço de Entrada sugerido para iniciar esta operação. Este pode mudar, considerando seu Gerenciamento de Risco.",
    ...
    gainPercent_hint: "Potencial lucro da operação.",
    lossPercent_hint: "Potencial Risco para o capital investido.",
    riskReward_hint: "Ganho Potencial dividido pela Risco. Quanto maior este número, melhor a operação.",
    radarOn_hint: "No Radar desde...",

    successRate_hint: "Este é o resultado do backtest para este Setup e Ativo.",
    estimatedTime_hint: "Estatisticamente falando, esta é uma mera estimativa de tempo para que o Ativo alcance o alvo.",
  ...
  technicalconditions: {
    ...
    pvpc_1292_long_p1: "Preço alcançou um suporte técnico chave após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Alta.",
    pvpc_1292_long_p2: "Linhas de Suporte estão alinhadas para cima, o que aumenta a probabilidade de início de uma longa onda 3.",
    pvpc_305_long_p1: "Preço alcançou um suporte técnico importante após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Alta.",
    pvpc_305_long_p2: "Linhas de Suporte estão alinhadas para cima, o que aumenta a probabilidade de início de onda 3.",
    pvpc_72_long_p1: "Preço alcançou um suporte técnico após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Alta, aumentando a probabilidade de, ao menos, o preço testar o topo anterior novamente.",

    pvpc_1292_short_p1: "Preço alcançou uma resistência técnica chave após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Baixa.",
    pvpc_1292_short_p2: "Linhas de Resistência estão alinhadas para baixo, o que aumenta a probabilidade de início de uma longa onda 3.",
    pvpc_305_short_p1: "Preço alcançou uma resistência técnica importante após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Baixa.",
    pvpc_305_short_p2: "Linhas de Resistência estão alinhadas para baixo, o que aumenta a probabilidade de início de onda 3.",
    pvpc_72_short_p1: "Preço alcançou uma resistência técnica após retração de <fibonacci.retracement_pct>% da Onda 1 e confirmou um Pivô de Baixa, aumentando a probabilidade de, ao menos, o preço testar o fundo anterior novamente.",
  },
  userfollowingitem: {
    label_follow: "Seguir",
