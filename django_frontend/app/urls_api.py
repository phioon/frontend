...
urlpatterns = [
    ...
    path('mycollections/', views.MyCollectionList.as_view()),
    path('mycollections/<int:pk>/', views.MyCollectionDetail.as_view()),
    path('collections/', views.CollectionList.as_view()),
    path('collections/<int:pk>/strategies/', views.CollectionStrategyList.as_view()),
    path('collections/<int:pk>/', views.CollectionDetail.as_view()),

    path('mystrategies/', views.MyStrategyList.as_view()),
    path('mystrategies/<uuid>/', views.MyStrategyDetail.as_view()),
    path('strategies/saved/', views.SavedSrategyList.as_view()),
    path('strategies/', views.StrategyList.as_view()),
    path('strategies/<uuid>/', views.StrategyDetail.as_view()),
